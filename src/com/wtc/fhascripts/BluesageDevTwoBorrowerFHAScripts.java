...
public class BluesageDevTwoBorrowerFHAScripts extends ActionDriver {
	...
	public static void setErrorCount(int errorCount) {
		BluesageDevTwoBorrowerFHAScripts.errorCount = errorCount;
	}
	...
	public static void setScript_id(String script_id) {
		BluesageDevTwoBorrowerFHAScripts.script_id = script_id;
	}
	...
	public static void setFilePath(String filePath) {
		BluesageDevTwoBorrowerFHAScripts.filePath = filePath;
	}
	...
	public void launchApp(ITestContext context) throws InterruptedException, IOException, InvalidFormatException {
		...
		script_id = "x_1";
		getWebdriverMethods("BluesageDevTwoBorrowerFHALoanMetaData",
				"BluesageDevTwoBorrowerFHALoanData");
