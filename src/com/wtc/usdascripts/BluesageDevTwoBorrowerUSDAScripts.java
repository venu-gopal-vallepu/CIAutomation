...
public class BluesageDevTwoBorrowerUSDAScripts extends ActionDriver {
	...
	public static void setErrorCount(int errorCount) {
		BluesageDevTwoBorrowerUSDAScripts.errorCount = errorCount;
	}
	...
	public static void setScript_id(String script_id) {
		BluesageDevTwoBorrowerUSDAScripts.script_id = script_id;
	}
	...
	public static void setFilePath(String filePath) {
		BluesageDevTwoBorrowerUSDAScripts.filePath = filePath;
	}
	...
	public void launchApp(ITestContext context) throws InterruptedException, IOException, InvalidFormatException {
		...
		script_id = "x_1";
		getWebdriverMethods("BluesageDevTwoBorrowerUSDAALoanMetaData",
				"BluesageDevTwoBorrowerUSDAALoanData");
